...
<Head>
   ...
   <div>
       <h6 class="font-medium text-sky-800">Admin/Roles</h6>
       <p>
        ...
        <div class="self-center">
            ...
            <label for="my-modal" class="btn-primary cursor-pointer">Create roles</label>
            <Teleport to="body">
                        ...
                        <div class="flex justify-between">
                         ...
                         <form @submit.prevent="submit" id="role-form">
                             ...
                             <div class="mt-7">
                                 ...
                                 <input type="text" class="sumo-input" id="role-guard" placeholder="Enter role guard" required v-model="form.guard_name"/>
    ...
    <div class="bg-white rounded-3xl shadow mt-8 overflow-hidden">
        ...
        <div class="bg-gray-100 p-3 flex justify-between">
            <div class="self-center">
                <h6 class="font-medium">Showing <span class="text-sky-800">{{roles.current_page}}</span> of <span class="text-sky-800">{{roles.last_page}}</span> Page(s)</h6>
            </div>
            <div class="flex">
                <Link :href="roles.prev_page_url" class="btn-primary text-xs m-1" v-if="roles.prev_page_url"><span class="mr-2"><i class="far fa-angle-left"></i></span>Prev</Link>
                <Link :href="roles.next_page_url" class="btn-primary text-xs m-1" v-if="roles.next_page_url">Next <span class="ml-2"><i class="far fa-angle-right"></i></span></Link>
